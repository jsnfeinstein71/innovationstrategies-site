...
export const metadata = {
  title: "Privacy Policy | Innovation Strategies LLC",
  description:
    "Privacy Policy for Innovation Strategies LLC, including internal SMS program information.",
};
      ...
      <section className="border-b border-white/10 bg-[#0a101a] py-16 sm:py-20">
        <div className="mx-auto max-w-4xl px-6 sm:px-8 lg:px-10">
          ...
          <div className="mt-8 space-y-5 text-base leading-7 text-slate-300">
            <p>
              Innovation Strategies LLC respects your privacy. We use business
              information only as needed to operate, maintain, and improve our
              services, systems, and communications.
            </p>
            <p>
